...
| Стили | SCSS | Совместимо с дизайн-токенами из `eighth-version/styles.css` |
...
### 2.2. Backend — рекомендуемый подход

> **Главная рекомендация: модульный монолит на .NET, а не микросервисы.**
