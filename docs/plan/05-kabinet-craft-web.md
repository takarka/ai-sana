...
|---|---|---|---|
| 1 | Каркас: shell контуров `platform`/`learn`/`teach` (`manage` пока не нужен — см. §16.2), меню, тема/плотность/язык, страницы ошибок | нет (моки) | §1, §11, §12 |
| 2 | Вход: логин, интерцепторы, refresh, guard'ы | `Identity` (узкий срез) | FR-CORE-03 |
