...
> **Уточнение от 11.09.2026.** Строка «одно приложение `craft-web`» в таблице
> ниже заменена [ADR-0005](0005-razdelenie-kabineta-na-admin-i-learn.md):
> кабинет разделён на `apps/admin` (контур `platform`) и `apps/learn` (контуры
> школы). Остальные позиции таблицы действуют без изменений.
