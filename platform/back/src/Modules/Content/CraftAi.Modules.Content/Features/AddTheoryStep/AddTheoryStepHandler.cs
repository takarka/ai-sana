...
internal static class AddTheoryStepHandler
{
    public static async Task<IResult> HandleAsync(
        Guid lessonId, AddTheoryStepRequest request, HttpContext httpContext, ContentDbContext db,
        CancellationToken cancellationToken)
    {
        ...
        var step = new LessonStep { Id = Guid.NewGuid(), LessonId = lessonId, Type = LessonStepType.Theory, Position = position };
