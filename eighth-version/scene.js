...
export function initScene(opts) {
  ...
  const baseColor = opts.base ? new THREE.Color(opts.base) : new THREE.Color(0x93a2c4);
  const ridgeColor = opts.ridge ? new THREE.Color(opts.ridge) : new THREE.Color(0x7e8bff);
